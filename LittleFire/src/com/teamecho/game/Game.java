...
public class Game {
    ...
    private final int Level_WINDOW_WIDTH = 1600;
    private final int Level_WINDOW_HEIGHT = 600;
    ...
    private void initScreens() {
        ...
        lvl1.setPreferredSize(new Dimension(Level_WINDOW_WIDTH, Level_WINDOW_HEIGHT));
